...
- The group determined discussed details about the elephant factor, as seen in [this presentation](slides/kpi_sig_presentation_10_september_2026.pptx).

## Action Items

- [ ] Oliver: Liaise with Abubakar concerning the elephant factor
