...
- The group determined the initial members:
  - Abubakar
  - Tristan
- The first action is to:
  - Gather information from the SIGs on what type of KPI's are needed
  - Establish prioritized KPI strategy
- Potentially invite others to this group. Advertise via Community Call. 

## Action Items

- [ ] Tristan: Create draft for KPI strategy document 
