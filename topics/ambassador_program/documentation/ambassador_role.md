...
Every Ambassador must be at least 18 years old. While not stringent, because our foundation focuses on cloud native projects, an ideal Ambassador is well versed in these topics.

## Who approves an Ambassador?

If not otherwise stated by the Outreach Committee, following an Ambassador application, the Outreach Committee votes with a simple majority on approving the applicant.
...
At least one the activities related to the following requirements must have occurred within the last 365 days:

-   Hosted at least one NeoNephos Community Call.
...
If the NeoNephos Foundation receives discount codes for participation at events, Ambassadors may also be able to utilize these codes.

### Merchandise to stock up on

Ambassadors receive some merchandise like T-Shirts, Hoodies and similar, so that they always have NeoNephos merch on hand for distribution at events.

## Requirements

To maintain an Ambassador status, the following activities may be conducted by the Ambassador:
...
-   run a NeoNephos booth at an event  

The Outreach Committee liaises with the Ambassador on the exact requirements, tailored to one's individual circumstances.

## Application

To become an Ambassador, apply through our Ambassador topic in the NeoNephos Zulip channel.
